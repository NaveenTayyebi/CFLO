...
classdef shockless
    methods(Static)
        ...
        function sonic_ref_plot(specHeatRatio,machRange,varargin)
               ...
               shockless.arg_2check(specHeatRatio,machNumber, property);
                switch prop
                    ...
                    case 'A'
                        ...
                        if (isequal(flowType,'fan') || isequal(flowType,'ray'))
         ...
         function computedValue = fanno_mach(specHeatRatio,duct_diameter, ...
                 friction_factor,quantity,varargin)
            return; 
         end 

         function computedValue = rayleigh_mach(specHeatRatio,duct_diameter, ...
                 friction_factor,quantity,varargin)
            return; 
         end
    end
