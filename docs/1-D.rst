...
.. raw:: html
   ...
   </span></em>, <em class="sig-param"><span class="n"><span class="pre">quantity</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">quantity</span>
   </span></em>, <em class="sig-param"><span class="n"><span class="pre">varargin</span>
...
Returns total fluid property ratio plots for isentropic, fanno, and rayleigh flows `[relations] <https://cflo.readthedocs.io/en/latest/doc_code/relations.html>`_
  ...
  **Parameters:** 
    * **spec_heat_ratio** (*double*) - The specifc heat ratio of the fluid 
    * **output** (*double array, size = [1 2]*) - The range of mach numbers to plot over 
    * **quantity** (*char* or *string*) - The property abbreviations. These include *'p'*, *'d'*, and *'T'* for pressure, density, and temperature respectively.
    * **varargin** (*char* or *string*) - The property abbreviations. These include *'p'*, *'d'*, and *'T'* for pressure, density, and temperature respectively.
